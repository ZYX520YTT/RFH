...
public class RoleGroupAdapter extends BaseAdapter {

    private List<RoleListInfo> list;
    private Context context;
    private int index;

    public RoleGroupAdapter(Context context, List<RoleListInfo> list, int index) {
